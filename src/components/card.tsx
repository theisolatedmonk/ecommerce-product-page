  ...
  return (
    <div className="cartfill bg-white absolute w-[270px] flex flex-col z-10 rounded-md ml-2 mt-14   text-xs  font-KumbhSans  hidden">
      ...
      <div className="w-full flex flex-col p-4 gap-4 ">
        ...
        <div className=" text-center font-bold text-[hsl(219,9%,45%)] py-12 hidden">Your cart is empty</div>
      </div>
    </div>
  );
}
...
export default function MobileMenu() {
  return (
    <div className="w-72 text-black h-screen bg-black flex  gap- z-30 fixed top-0 bg-opacity-70 text-xs font-bold hidden ">
...
export function NextBtn({}: Props) {
  return (
    <svg
    className={"fill-none rounded-full  hover:stroke-[hsl(26,100%,55%)] stroke-black " } 
...
export function PreviousBtn({}: Props) {
  return (
    <svg width="12" height="18"  className=" hover:stroke-[hsl(26,100%,55%)] stroke-black" xmlns="http://www.w3.org/2000/svg">
      <path
        d="M11 1 3 9l8 8"
        // stroke="#1D2026"
        stroke-width="3"
...
function DeleteSvg(props: JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={14}
      height={16}
